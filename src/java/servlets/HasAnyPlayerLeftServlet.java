        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            if (currGame != null) {
                if (playerNameFromSession.equals(currGame.getCurrPlayer().getPlayerName())) {
                    qp.setItPlayerSessionTurn(true);
                } else {
                    qp.setItPlayerSessionTurn(false);
                }
            }

            if (playerNameFromSession.equals(qp.getPlayerLeftName())) {
                qp.setDidILeave(true);
                SessionUtils.clearSession(request);
            } else {
                qp.setDidILeave(false);
            }
