...
public class QuitPlayer {
        ...
        private boolean isItPlayerSessionTurn;
        private boolean didILeave;
    ...
    public void setItPlayerSessionTurn(Boolean var)
    {
        isItPlayerSessionTurn = var;
    }
    /**
    ...
    /**
     * @param didILeave the didILeave to set
     */
    public void setDidILeave(boolean didILeave) {
        this.didILeave = didILeave;
    }      

    /**
     * @return the playerLeftName
     */
