...
var quitVersionID = 0;
var isCompPlayed = false;
var turnDataInterval, playerLeftInterval, compTurnInterval, playersInterval;
var amIIn = true;
            ...
            if (r.howManyLeftToJoin == 0 && !isGameStarted) {
                ...
                if (!isFirstHumanPlayed) {
                    if (currPlayerType == "HUMAN") {
                        ...
                        setTimerAtServer();
                        playerLeftInterval = setInterval(hasPlayerLeft, 1000);
                    }
                }
                ...
                turnDataInterval = setInterval(requestLastTurnData, 1000);
